...
SITE_LAT <- 47.210227
SITE_LON <- 8.410645
INPUT_FLUX <- "NEE_L3.1_L3.3_CUT_16_QCF"
OUTPUT_FLUX <- "NEE_CUT_16"
SUFFIX <- "CUT_16"
...
write.csv(FilledEddyData.F, file = paste(OUTDIR, "33.04_FLUXES_L4.1_MDSgapfilled_", OUTPUT_FLUX, "_", run_id,".csv",sep="")) 
